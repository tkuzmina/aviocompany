...
<?php foreach ($types as $type): ?>
    ...
    <table class="registerFormContent">
        <tr>
            <fieldset class="control-group error"><td class="passengerFormLabel"><?=$this->lang->line('ui_person_name')?>:</td><td><?=form_input('name'.$passenger_no, set_value('name'.$passenger_no), validation_class("name".$passenger_no))?></td></fieldset>
