...
$lang['ui_choose']= "Choose and go to the next reservation step";
...
$lang['ui_dates_in_past']= "Flight dates cannot be in past.";
$lang['ui_dates_not_match']= "Return date cannot be earlier that flight date.";
$lang['ui_payment_details']= "Payment details";
$lang['ui_cardholder_name']= "Card holder name";
$lang['ui_card_number']= "Card number";
$lang['ui_card_expiration_date']= "Card expiration date";
$lang['ui_card_cvv2']= "CVV2 (if present)";
$lang['ui_rule_required']= "The %s field is required.";
$lang['ui_rule_max_length']= "The %s field can not exceed %s characters in length.";
$lang['ui_rule_valid_email']= "The %s field must contain a valid email address.";
$lang['ui_rule_integer']= "The %s field must contain an integer.";
$lang['ui_rule_less_than']= "The %s field must contain a number less than %s.";
